...
public class VideoSplit {
	...
	public static void main(String[] args) {
		...
		String file1 = "D:\\java视屏\\案例\\shirui\\video.wmv";
		String file2 = "D:\\java视屏\\案例\\shirui\\video.wmv";
	...
	public static long getWrite(String file, int index, long fbegin, long fend) {
		...
		try {
			...
			RandomAccessFile out = new RandomAccessFile(new File(file + "_" + index), "rw");  // 输出文件
